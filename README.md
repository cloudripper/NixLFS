...
- **System configuration**: `derivations/sys_conf/sys_conf.nix` contains the system configuration (incl: Ch 8. Stripping, Ch 9, and Ch 10 details). This should be adapted and customized to your needs.
