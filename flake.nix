{
  ...
  outputs = { self, nixpkgs }:
    let
      ...
      fhsPythonStage = import ./derivations/fhs/fhspython.nix { pkgs = x86_pkgs; lfsSrcs = lfsSrcList; cc2 = fhsPerlStage; };
      fhsTexinfoStage = import ./derivations/fhs/fhstexinfo.nix { pkgs = x86_pkgs; lfsSrcs = lfsSrcList; cc2 = fhsPythonStage; };
      fhsUtilLinuxStage = import ./derivations/fhs/fhsutillinux.nix { pkgs = x86_pkgs; lfsSrcs = lfsSrcList; cc2 = fhsPythonStage; };
