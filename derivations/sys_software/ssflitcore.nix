...
let
  ...
  fhsEnv = stdenv.mkDerivation {
    name = "ss-flitcore-env";

    src = builtins.fetchTarball {
      url = lfsSrcs.flit_core;
      sha256 = "0bpzi8ij2pbqj7wcqfmgha7g571nv8kn7r3gg1cxavyxn410cfwz";
    };
  ...
  setupEnvScript = ''
    ...
    set -e
    cd /tmp/src
    find /{usr,sbin,bin,lib,var,tmp/src} -exec touch {} +
